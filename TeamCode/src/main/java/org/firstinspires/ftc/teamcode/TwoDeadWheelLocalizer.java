...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2491.3303098403157; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -885.7939948992228; // x position of the perpendicular encoder (in tick units)
    }
